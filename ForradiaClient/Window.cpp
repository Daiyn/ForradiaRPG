...
Window::Window(int _x, int _y, int _w, int _h, int _uniqueNPCID, string _title)
{
...
void Window::Update()
{
    ...
    Rectangle rect = { m_x + m_w - iconCloseWindowSize - m_pxTitleBarMargin, m_y + m_pxTitleBarMargin, iconCloseWindowSize, iconCloseWindowSize };


}

bool Window::HandleMouseClickInWindowBase()
{
...
bool Window::HandleMouseReleaseInWindowBase()
{
...
bool Window::HandleMouseReleaseInWindow()
{
...
bool Window::CheckMouseClickInWindow()
{
...
bool Window::HandleMouseClickInWindow()
{
...
void Window::RenderBase()
{
    ...
    Rectangle rect = { m_x, m_y, m_w, m_h };
