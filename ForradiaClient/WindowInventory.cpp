...
bool WindowInventory::HandleMouseClickInWindow()
{
...
bool WindowInventory::HandleMouseReleaseInWindow()
{
    ...
    for (int row = 0; row < numberOfRows; row++)
    {
        ...
        for (int col = 0; col < numCols; col++)
        {
            ...
            if (mx >= posx && my >= posy && mx < posx + m_pxSlotSize && my < posy + m_pxSlotSize)
            {
                ...
                Global::statePlayer->m_inventory.m_containedItems.insert(std::pair<int, unique_ptr<Object>>(i, move(ItemMoving::nodupMovedObject)));
                return true;
...
void WindowInventory::Render()
{
    ...
    for (int row = 0; row < numberOfRows; row++)
    {
        ...
        for (int col = 0; col < numCols; col++)
        {
            ...
            Drawing::Image(ImagesIDs::InventorySlotBackground, posx, posy, m_pxSlotSize, m_pxSlotSize);
